...
public class SeckillController {
    ...
    public String dateil(@PathVariable("seckillId") Long seckillId, Model model){
        if(seckillId==null){
    ...
    public SeckillResult<SeckillExecution> execute(@PathVariable("seckillId") Long seckillId,@PathVariable("md5") String md5,
        ...
        try {
            ...
            SeckillExecution execution = new SeckillExecution(seckillId, SeckillStatEnum.REPEAST_KILL);
            return new SeckillResult<SeckillExecution>(true, execution);
